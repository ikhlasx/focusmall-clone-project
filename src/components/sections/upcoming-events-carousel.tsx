    ...
    <section className="bg-background py-20 lg:py-24">
      <div className="container">
        <div className="flex flex-col md:flex-row justify-between md:items-center mb-12 gap-4">
          ...
          <a
            href="#"
            className="bg-primary hover:bg-orange-500 text-primary-foreground font-semibold py-[11px] px-[18px] rounded-[5px] transition-colors text-[15px] text-center whitespace-nowrap leading-none tracking-[0.5px]"
          >
            View All Events
          </a>
        </div>
