...
const eventData: EventCardProps[] = [
  ...
  {
    title: "Inauguration of Mall",
    image: "/events/Launching.jpeg",
    startDate: "April 1, 2026",
    endDate: "April 30, 2026",
    description: "Join us for the grand inauguration of our mall. Experience the opening ceremony, special discounts, live entertainment, and exclusive offers throughout the month of April.",
  },
  {
